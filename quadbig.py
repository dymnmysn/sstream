...
class Embedding(nn.Module):
    ...
    """
    def process_block(self, block_logits, embeddings, offset=0, k=7):
        # Get top-k indices
...
class Encoder(nn.Module):
    def __init__(self, n_channels: int, padding):
        ...
        self.layers = nn.Sequential(
            ...
            nn.Conv1d(16 * n_channels, 256 * n_channels, kernel_size=3, padding=padding),
        )
...
class StreamableModel(pl.LightningModule):
    def __init__(
        ...
        version: str = 'quadbig',
        checkpoint: str = '/ari/users/ibaskaya/projeler/sstream/lightning_logs/version_63/checkpoints/last.ckpt'
    ) -> None:
